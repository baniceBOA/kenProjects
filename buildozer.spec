...
# (str) Package name
package.name = projectilemotioncalculator

# (str) Package domain (needed for android/ios packaging)
package.domain = com.projectilemotioncalculator 
...
requirements = python3==3.11.9, hostpython3==3.11.9, kivy==2.3.0, kivymd==1.2.0, libffi==3.4.4
